...
export default class DevServer {
    ...
    async start ( compiler, { proxyUrl, https = {} } = {} ) {
        ...
        try {
            ...
            this.#httpsDomain = crypto.localDomain;
            this.#options.server.options.cert = crypto.localCertificatePath;
            this.#options.server.options.key = crypto.localPrivateKeyPath;
        }
