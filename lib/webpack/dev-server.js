...
export default class DevServer {
    ...
    async start ( compiler, { proxyUrl, https = {} } = {} ) {
        ...
        try {
            ...
            this.#httpsDomain = certificates.defaultHttpsDomain;
            this.#options.server.options.cert = certificates.defaultHttpsCertificate;
            this.#options.server.options.key = certificates.defaultHttpsPrivateKey;
        }
