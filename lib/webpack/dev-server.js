...
const defaultHttpsDomain = "local.softvisio.net",
    defaultHttpsCert = resolve( "#resources/local.softvisio.net/crt.pem", import.meta.url ),
    defaultHttpsKey = resolve( "#resources/local.softvisio.net/key.pem", import.meta.url );
