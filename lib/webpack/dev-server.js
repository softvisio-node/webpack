...
export default class DevServer {
    ...
    async start ( compiler, { proxyUrl, https = {} } = {} ) {
        ...
        try {
            ...
            this.#httpsDomain = certificates.defaultTlsDomain;
            this.#options.server.options.cert = certificates.defaultTlsCertificate;
            this.#options.server.options.key = certificates.defaultTlsPrivateKey;
        }
