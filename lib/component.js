...
export default class WebpackComponent {
    ...
    constructor ( webpack, name, { buildOptions, appConfig, preprocessorDirectives, preprocessorParams } = {} ) {
    ...
    get resolveAlias () {
        return {
            ...
            "#firebaseMessagingWorker$": path.join( this.tmpPath, "firebase-messaging.worker.js" ),
        };
    }
